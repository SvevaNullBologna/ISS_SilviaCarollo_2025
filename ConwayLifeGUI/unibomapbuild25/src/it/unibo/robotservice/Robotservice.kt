		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t00",targetState="handleInit",cond=whenDispatch("init"))
				}	 
				state("handleInit") { //this:State
					action { //it:State
						CommUtils.outgreen("$name in ${currentState.stateName} | $currentMsg | ${Thread.currentThread().getName()} n=${Thread.activeCount()}")
						 	   
						 dreaming = false  
						if( checkMsgContent( Term.createTerm("init(DREAMING)"), Term.createTerm("init(true)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								CommUtils.outgreen("$name | is dreaming ... ")
								 dreaming = true  
						}
						//genTimer( actor, state )
					}
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t01",targetState="dohalt",cond=whenDispatch("halt"))
					transition(edgeName="t02",targetState="domove",cond=whenDispatch("move"))
					transition(edgeName="t03",targetState="domoverequest",cond=whenRequest("cmd"))
					transition(edgeName="t04",targetState="handleAsynchStep",cond=whenRequest("step"))
				}	 
				...
				state("handleVrinfoMsgReply") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("vrinfo(SOURCE,INFO)"), Term.createTerm("vrinfo(S,elapsed)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								if(  doingAsynchStep  
								 ){CommUtils.outyellow("$name | reply asynchstep  ")
				...
				state("handleAsynchStep") { //this:State
					...
					transition(edgeName="t010",targetState="dohalt",cond=whenDispatch("halt"))
				}	 
			}
		}
} 
